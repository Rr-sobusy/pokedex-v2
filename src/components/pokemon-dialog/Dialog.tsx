...
import PokemonDialogLoader from "../loader/pokemon-dialog-loader";
                          ...
                          {poke?.length > 0 ? (
                            poke.map(({ pokemons, minLevel }, index) => (
                              ...
                              >
                                ...
                                <p className="font-sans text-sm font-semibold flex justify-center text-slate-600">{`Min Level : ${
                                  minLevel ? minLevel : 0
                                }`}</p>
                                <div className="grid justify-center">
                                  <Image
                            ...
                            <p className="grid items-center justify-center text-slate-700 uppercase font-semibold">
